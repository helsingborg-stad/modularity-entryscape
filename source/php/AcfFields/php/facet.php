    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            1 => [
                ...
                'type' => 'url',
                'instructions' => __(
                    'Add an url to your entryscape installation https://subdomain.domain.se. Leave out the folder part from configuration.',
            ...
            3 => [
                ...
                'type' => 'page_link',
                'instructions' => __(
                    'Select a target page where you have your single-view module attached.',
                    'modularity-entryscape',
                ),
                'required' => 1,
                'conditional_logic' => 0,
