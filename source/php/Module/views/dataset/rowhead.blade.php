<div class="esbRowHead">
  <a href="@{{prop "dcat:accessURL"}}" class="pull-right btn btn-sm btn-primary" role="button" target="_blank">
    <i class="fa fa-external-link-square-alt" aria-hidden="true"></i>Webpage</a> 
