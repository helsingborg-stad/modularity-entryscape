    ...
    blocks: [
        {
            ...
            htemplate: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetView")); ?>',
        },
        {
            block: 'distributionList',
            extends: 'template',
            relation: 'dcat:distribution',
            template: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.collection")); ?>',
        },
        {
            ...
            template: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetFacetSearchLayout")); ?>',
        },
        {
            ...
            use: 'datasetlist',
            live: 'polite',
            templateFilter: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetResults")); ?>',
            templateNoFilter: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetResults")); ?>',
        },
        {
            block: 'datasetList',
            extends: 'list',
            ...
            listplaceholder: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.notice", ["title" => "Inga resultat", "message" => "Inga dataset matchar kriterierna du angav."])); ?>',
            ...
            rowhead: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetListRowHead")); ?>',
            rowexpand: '',
            listbody: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.datasetListBody")); ?>',
            layout: 'raw'
        }/*, 
        {  
            block: 'entryList',
            extends: 'template',
            template: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.entryList")); ?>',
        },
        {
            block: 'searchList',
            extends: 'template',
            template: '<?php echo preg_replace( "/\r|\n/", "", render_blade_view("dataset.searchList")); ?>',
        }*/ 
    ]
}]);
</script>
