...
namespace ModularityEntryscape\Entity;
...
class PostType
{
    ...
    public function registerPostType()
    {
        $labels = array(
            ...
            'add_new'             => sprintf(__('Add new %s', 'modularity-entryscape'), $this->nameSingular),
            'add_new_item'        => sprintf(__('Add new %s', 'modularity-entryscape'), $this->nameSingular),
            'edit_item'           => sprintf(__('Edit %s', 'modularity-entryscape'), $this->nameSingular),
            'new_item'            => sprintf(__('New %s', 'modularity-entryscape'), $this->nameSingular),
            'view_item'           => sprintf(__('View %s', 'modularity-entryscape'), $this->nameSingular),
            'search_items'        => sprintf(__('Search %s', 'modularity-entryscape'), $this->namePlural),
            'not_found'           => sprintf(__('No %s found', 'modularity-entryscape'), $this->namePlural),
            'not_found_in_trash'  => sprintf(__('No %s found in trash', 'modularity-entryscape'), $this->namePlural),
            'parent_item_colon'   => sprintf(__('Parent %s:', 'modularity-entryscape'), $this->nameSingular),
